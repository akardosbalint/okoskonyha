...
## A batch cooking 3 alapelve

A rendszer három, egymásra épülő lépésből áll — ha ezt a hármat érted, a többi már csak gyakorlat kérdése.

### 1. Heti tervezés

Ez a lépés dönti el, hogy a hét sikeres lesz-e. A cél nem az, hogy hét különböző, bonyolult receptet főzz, hanem hogy néhány jól megválasztott alapkomponenst készíts el, amikből aztán variálsz. Erről bővebben ír a [tányér-elvről szóló cikkem](/blog/tanyer-elv-kiegyensulyozott-etkezes/) — érdemes azt is elolvasni, mielőtt nekiállsz a heti tervnek.

### 2. Tárolás

Hűtve vagy fagyasztva, adagolva, címkézve — így sosem kell találgatnod, mi mennyi ideje áll a hűtőben, és mi az, amit még biztonsággal megehetsz. Ez az a lépés, amit a legtöbben elhanyagolnak, pedig itt dől el, hogy a heti főzésedből tényleg egy egész hétre elég, jó minőségű étel lesz-e, vagy csütörtökre már mindent kidobsz. Ezt a témát külön, részletesen is kifejtettem a [fagyasztásról és tárolásról szóló cikkemben](/blog/fagyasztas-tarolas-batch-cooking/).

### 3. Kombinálás

Az előfőzött elemekből percek alatt összeáll egy változatos, friss étel. Ugyanaz a sült tofu más lesz egy tálban tahinis szósszal, és más egy wrapban zöld szósszal — pedig ugyanabból a két alapanyagból dolgozol.
...
**Csak egyféle ízesítést használsz.** Ha mind a három napi étel ugyanazzal a fűszerezéssel készül, az ötödik adagra tényleg unalmas lesz. A három különböző szósz pont ezt oldja meg — használd ki őket tudatosan.
...
A batch cooking nem arról szól, hogy egy egész hétre ugyanazt az egy ételt eszed. A trükk az alapkomponensek okos kombinálásában van — ezt tanítom meg lépésről lépésre az [Okoskonyhában](/okoskonyha/), a Batch Cooking Alapkurzus keretében, ahol heti max. 2 főzéssel oldjuk meg az egész heti étkezésedet, együtt a közösséggel.
